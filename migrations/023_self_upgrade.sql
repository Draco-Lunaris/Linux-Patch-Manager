...
-- Stores release information fetched from GitHub or custom URLs
...
-- Add upgrade-specific columns to patch_job_hosts
ALTER TABLE patch_job_hosts ADD COLUMN IF NOT EXISTS upgrade_url TEXT;
ALTER TABLE patch_job_hosts ADD COLUMN IF NOT EXISTS upgrade_checksum TEXT;
ALTER TABLE patch_job_hosts ADD COLUMN IF NOT EXISTS upgrade_version TEXT;
